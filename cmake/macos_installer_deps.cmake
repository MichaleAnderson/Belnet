...
ExternalProject_Add(belnet-gui
    ...
    CMAKE_ARGS -DMACOS_APP=ON -DCMAKE_INSTALL_PREFIX=${PROJECT_BINARY_DIR} -DMACOS_SIGN=${MACOS_SIGN_APP}
        ...
        "-DBMQ_LIBRARIES=$<TARGET_FILE:bmq::bmq>$<SEMICOLON>$<TARGET_FILE:libzmq>$<SEMICOLON>$<TARGET_FILE:sodium>"
        "-DBMQ_INCLUDE_DIRS=$<TARGET_PROPERTY:bmq::bmq,INCLUDE_DIRECTORIES>"
        )
